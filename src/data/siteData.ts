...
export const FOUNDER_MILESTONES = [
  {
    ...
    subtitle: '空間透視構建・三維光影初探',
    description: '開啟婚禮紀錄的影像大門，奠定空間透視與三維光影的基礎。',
    iconName: 'Sparkles',
    type: '影像啟蒙'
  },
  {
...
export const SERVICES_CATALOG: ServiceItem[] = [
  ...
  },
  {
    ...
    subtitle: '農產品行銷影像力：手機商業攝影與短影音雙軌實戰班（2 天共 12 小時）',
    category: 'enterprise',
    categoryLabel: '農會與機構實戰內訓',
    tagline: '2 天 12 小時全實戰！零基礎帶走「產地情境行銷海報」與「高轉換商業短影音」雙料成果',
    duration: '2 天班 ｜ 每日 6 小時共 12 小時（全實戰演練・專案客製）',
    format: '實體工作坊 / 機構客製包班 / 雙料成品驗收',
    targetAudience: ['地方農會與青農團體', '農特產與產地自營品牌', '文創工藝與地方創生團隊', '企業行銷與社群推廣人員'],
    description: '以「嘉義縣竹崎地區農會」特聘實戰為標竿。專為無影音基礎團隊打造，揚棄繁複枯燥的技術術語，獨家提煉「四大實戰里程碑體系」。運用隨手可得的產地自然光與手機原生鏡頭，2 天 12 小時內帶領學員現場完成「產地促銷商業海報」與「15-30 秒動態行銷短片」，課堂即完成可直發 FB/IG/LINE 的即戰力作品！',
    highlights: [
      '雙成果交付保證：Day 1 完成產地促銷海報，Day 2 完成 15-30 秒商業行銷短片',
      '嘉義竹崎農會實證背書：輔導超過 50 位青農全員獨立產出，滿意度高達 98%',
      '獨家專利教學心法：不背參數、不買昂貴設備，一套 SOP 終身適用產地日常記錄',
      '現場實物手把手講評：分組實作自家水果/茶葉/特產，悟哥逐組巡迴指導與即時講評',
      '機構專屬企劃書支援：支援公部門與企業投標、核銷與客製化課綱彈性調整'
    ],
    modules: [
      { 
        title: '里程碑 01 ｜ 產地質地與光影直覺法', 
        description: '跳脫器材迷思！掌握自然光與簡易補光技巧，拍出水果鮮度、茶葉焙度與農產新鮮光澤' 
      },
      { 
        title: '里程碑 02 ｜ 商業商品構圖與社群海報封裝', 
        description: '經典三分構圖與情境道具層次擺設，將產地隨手拍升級為具備品牌標識與促銷文案的社群宣傳海報' 
      },
      { 
        title: '里程碑 03 ｜ 電影感動態運鏡與鏡頭語言實戰', 
        description: '掌握推拉平移與特寫節奏走位，用手機拍出具備呼吸感、故事張力與引導購買慾的動態短影音鏡頭' 
      },
      { 
        title: '里程碑 04 ｜ 高效率剪輯工作流與全渠道社群轉化', 
        description: '傻瓜化手機拍剪 SOP，快速完成節奏配樂、自動字幕與風格調色，封裝出直發 FB/IG/LINE 的高轉換短片' 
      }
    ],
    featured: true,
    priceTag: '機構首選・口碑保證',
...
export const PORTFOLIO_CASES: PortfolioItem[] = [
  ...
  },
  {
    ...
    image: 'https://assets.cine-dimension.com/shell%20.PNG',
    highlights: [
  ...
  },
  {
    ...
    year: '2006-2020',
    description: '在極高壓、不可逆的現場環境下捕捉最真摯的人情溫度，運用敏銳的鏡頭語言與光影美學留下永恆的感動瞬間。\n\n【關島海外婚禮實戰代表作】本片為遠赴關島拍攝之海外婚禮電影作品。全案事前歷時 5 個月精密規劃，與團隊共同完成跨國企劃、分鏡腳本與海外器材統籌配置；由悟哥一人遠赴關島現場掌鏡，於異地氣候與不可逆時程高壓下完成五天三夜全實境拍攝，返台後與團隊歷時近一個月傾力完成電影級調色與剪輯後製。完美見證一人赴海外單兵作戰的頂級掌鏡功底，以及團隊精密協作的高規格製作實力。',
    role: '資深攝影師 / 動態錄影師',
    tags: ['婚禮紀錄', '關島海外婚禮', '人像光影', '情緒捕捉', '現場實戰'],
    image: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=800&q=80',
    videoUrl: 'https://www.youtube.com/watch?v=owTBrg-aBhE&list=PL8OpV9U_sLi90w5HHO3AVOY0FBn4LYHsx&index=2',
    highlights: [
      '跨越靜態至動態錄影百場實戰經驗',
      '深厚的人像情感引導與自然光影敏銳度',
      '關島海外婚禮代表作：一人遠赴海外掌鏡五天三夜，團隊歷時近半年籌劃與電影級精剪'
    ]
  }
];
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    name: '張先生',
    role: '在地返鄉青農 / 水果產銷班',
    organization: '嘉義竹崎農會手機影音班學員',
    quote: '「影片剪出來超級讚！非常感謝農會開辦這門實戰課程。學會手機實戰運鏡、自然光取景跟快速剪輯後，自家農特產的行銷質感完全提升一個檔次，預計明年農產品可以直接多收 20 萬的營業額！」',
    avatar: '/images/avatar-chang.svg',
    serviceUsed: '嘉義竹崎農會手機商業拍攝班',
    tags: ['預期多收20萬', '農產行銷大突破', '實用性極高']
  },
  {
    id: 't2',
    name: '蘇小姐',
    role: '農場主理人',
    organization: '心滿藝竹農場（竹崎農會學員）',
    quote: '「實在是超級讚的課程！謝謝農會重金請來這麼厲害的老師。老師教的照片調色與影片後製，我馬上現學現賣做出芭樂宣傳海報、樹葡萄果醬影片，還申請好農場 LINE 官方帳號與 QR Code，會持續練習老師教的扎實功夫！」',
    avatar: '/images/avatar-su.svg',
    serviceUsed: '嘉義竹崎農會手機商業拍攝班',
    tags: ['謝謝農會重金請名師', '現學現賣做海報', '果醬短片產出']
  },
  {
    id: 't3',
    name: '王小姐',
    role: '推廣部活動承辦主辦',
    organization: '嘉義縣竹崎地區農會',
    quote: '「悟哥的 2 天 12 小時全實戰課程非常接地氣！跳脫傳統講堂的死板理論，直接帶在地農友拿手機實境拍攝、調色與成片。看到群組裡學員熱烈反饋『重金請來非常值得』，甚至直接預期帶動營業額，是公認成效最卓越的培訓！」',
    avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=200&q=80',
    serviceUsed: '農會・機構客製影音內訓',
    tags: ['機構內訓首選', '學員滿意度極高', '兩天全實戰成果']
  }
];
